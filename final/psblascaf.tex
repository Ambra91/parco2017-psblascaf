...
Secondly, strong scalability tests have been performed for both 2D and 3D problems. Again, halo exchange with sync images performs better: for this reason in the following we show only the results for this case. Table~\ref{strong} shows results for the 3D problem.
 %
\begin{table}[ht]
\centering
...
\begin{table}[ht]
\centering
\caption{Strong scaling for a 3D problem: BiCGSTAB with a 2 level preconditioner ($a_1=a_2=a_3=1$, $b_1=b_2=b_3=0$, $c=0$,$idim=200$}
\label{Strong2}
\begin{tabular}{@{}rrrll@{}}
